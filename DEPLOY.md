...
The repo name **must be `personal_web_claude`** (it must match `base` in `site/astro.config.mjs`).

## One-time setup

1. Create an empty repo at github.com/new named `personal_web_claude` (public, no README).

2. From this folder (`personal_web_claude/`), run:
   ...
   git branch -M main
   git remote add origin https://github.com/aliparchekan/personal_web_claude.git
...
5. Site is live at: **https://aliparchekan.github.io/personal_web_claude/**
